...
<html lang="en">
  ...
  <body>
      ...
      <div class="call-to-action">
        <h2 id="nav-tabs">Welcome Patient</h2>
        ...
        <div class="services">
            <div id="myTabContent" class="tab-content">
              ...
              <div class="tab-pane fade active in" id="login">
                <form action=patient_personal_page.php method=POST class="form-horizontal" role="form">
                  <br>
              ...
              <div class="tab-pane fade" id="signup">
                <form action=patient_register_handler.php method=POST class="form-horizontal" role="form">
                   <br>
                    <div class="form-group">
                      <label for="inputUsername3" class="col-sm-2 control-label">Username</label>
                      <div class="col-sm-3">
